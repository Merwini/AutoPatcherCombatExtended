...
namespace nuff.AutoPatcherCombatExtended
{
    ...
    {
        internal static void PatchVehicle(VehicleDef def, APCEPatchLogger log)
        {
            try
            {
        ...
        internal static void PatchVehicleTurret(VehicleTurretDef def, APCEPatchLogger log)
        {
            try
            {
        ...
        internal static ThingDef CreatePseudoWeapon(VehicleTurretDef def)
        {
