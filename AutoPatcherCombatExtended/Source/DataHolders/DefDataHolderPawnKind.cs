...
class DefDataHolderPawnKind : DefDataHolder
{
    ...
    public override void GetOriginalData()
    {
        ...
        logBuilder.AppendLine($"Starting GetOriginalData log entry for PawnKind {def?.defName ?? "NULL DEF"}");
    ...
    {
        logBuilder.AppendLine($"Starting AutoCalculate log entry for PawnKind {def?.defName ?? "NULL DEF"}");
    ...
    {
        logBuilder.AppendLine($"Starting ApplyPatch log entry for PawnKind {def?.defName ?? "NULL DEF"}");
