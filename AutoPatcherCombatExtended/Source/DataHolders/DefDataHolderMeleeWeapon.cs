...
public class DefDataHolderMeleeWeapon : DefDataHolder
{
    ...
    public override void GetOriginalData()
    {
        ...
        logBuilder.AppendLine($"Starting GetOriginalData log entry for Melee Weapon {def?.defName ?? "NULL DEF"}");
        ...
        {
            logBuilder.AppendLine($"Finished GetOriginalData log entry for {def?.defName ?? "NULL DEF"}");
        }
    }

    public override void AutoCalculate()
    {
        logBuilder.AppendLine($"Starting AutoCalculate log entry for Melee Weapon {def?.defName ?? "NULL DEF"}");
        ...
        {
            logBuilder.AppendLine($"Finished AutoCalculate log entry for {def?.defName ?? "NULL DEF"}");
        }
    }

    public override void ApplyPatch()
    {
        logBuilder.AppendLine($"Starting ApplyPatch log entry for Melee Weapon {def?.defName ?? "NULL DEF"}");
        ...
        {
            logBuilder.AppendLine($"Finished ApplyPatch log entry for {def?.defName ?? "NULL DEF"}");
        }
    }
