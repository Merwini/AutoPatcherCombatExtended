...
{
    class Window_SelectTurretAmmoSet : Window
    {
        ...
        public Window_SelectTurretAmmoSet(DefDataHolderVehicleTurretDef dataHolder)
        {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            {
                dataHolder.modified_AmmoSetString = selectedDef.defName;
                Close();
            }
