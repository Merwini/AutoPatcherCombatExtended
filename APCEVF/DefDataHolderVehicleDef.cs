...
public class DefDataHolderVehicleDef : DefDataHolder
{
    ...
    public override void GetOriginalData()
    {
        ...
        logBuilder.AppendLine($"Starting GetOriginalData log entry for VehicleDef {def?.defName ?? "NULL DEF"}");
    ...
    {
        logBuilder.AppendLine($"Starting AutoCalculate log entry for VehicleDef {def?.defName ?? "NULL DEF"}");
    ...
    {
        logBuilder.AppendLine($"Starting ApplyPatch log entry for VehicleDef {def?.defName ?? "NULL DEF"}");
